 ...
 */
package com.example.esp32dht.Tools.service;
...
import com.example.esp32dht.Tools.service.MessageStore.StoredMessage;
...
class MqttConnection implements MqttCallbackExtended {
	...
	MqttConnection(MqttService service, String serverURI, String clientId,
		...
		wakeLockTag = this.getClass().getCanonicalName() + " " +
				clientId +
				" " +
				"on host " +
				serverURI;
	...
	public void connect(MqttConnectOptions options, String invocationContext,
		...
		if (connectOptions != null && connectOptions.isCleanSession()) { // if it's a clean session,
			// discard old data
